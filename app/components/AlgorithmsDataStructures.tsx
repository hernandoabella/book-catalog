  ...
  const books = [
    {
      ...
      description:
        "This Book is perfect for beginners who want to understand the concept of DSA (Data Structures and Algorithms) in the Python programming language quickly and concisely.",
    },
