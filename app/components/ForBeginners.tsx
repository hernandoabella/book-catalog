  ...
  const books = [
    {
      ...
      description:
        "Comprehensive guide to JavaScript covering basic syntax, DOM manipulation, and asynchronous programming.",
    },
    {
      ...
      description:
        "Practical approach to learning Rust, focusing on ownership, borrowing, and lifetimes.",
    },
  ];
