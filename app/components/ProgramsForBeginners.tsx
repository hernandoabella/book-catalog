...
const ProgramsForBeginners = () => {
  ...
  const books = [
    {
      title: "JavaScript Programs for Beginners",
      link: "https://www.amazon.com/-/es/Hernando-Abella/dp/B0CQ5KVQGH",
      image: "/programs-for-beginners-js.jpg",
      description:
        "A collection of beginner-friendly JavaScript programs designed to enhance your coding skills. Explore basic syntax, DOM manipulation, and asynchronous programming concepts with practical examples.",
    },
    {
      title: "Rust Programs for Beginners",
      link: "https://www.amazon.com/-/es/Hernando-Abella-ebook/dp/B0CVLHT1VP",
      image: "/programs-for-beginners-python.jpg",
      description:
        "Discover a curated selection of Rust programs tailored for beginners. Dive into ownership, borrowing, and lifetimes to strengthen your understanding of this powerful language.",
    },
  ];
